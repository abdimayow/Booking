...
<div class="container main">  
  		...
  		<%		
  			ArrayList<Blocks> b = (ArrayList<Blocks>)session.getAttribute("blocks");
...
<div class="wrapper">
    ...
    <%Blocks c = b.get(i); %>
						...
						<div class="view_item">
				<div class="vi_left">
					<img src="img/blocks.png" alt="group">
				</div>
				<div class="vi_right">
					<p class="title"><h4>Block Name:<%= c.getBlockname() %></h4></p>
                     
					<form action="StudentBook" method="Post" >
					<input type="hidden" name="blockid" value="<%= c.getBlockid() %>" />
					
					<input   class="btn" type="submit" name="submit"  value="book hostels">
					</form>
