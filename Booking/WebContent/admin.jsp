  ...
  <div class="row" style="min-height=200px;"></div>
      ...
      <div class="row">
       ...
       <div class="col-xs-12 customDiv1"></div>     
                 ...
                 <div class="col-xs-10 col-xs-offset-2 customDiv2"><h4 >Admin Login Form</h4></div>
                ...
                <form class="form-horizontal"  action="Login" method="Post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-10">
                        <input class="form-control" type="password" id="inputPassword" name="AdminPassword" placeholder="Password">
