...
/**
 * Servlet implementation class StudentBook
 */
@WebServlet("/StudentBook")
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(stu.getRegno()!=null) {
			...
			case "C":
				...
				session.setAttribute("failurebooking", "You are in group "+grpname+"! Your group leader will book for you");
			...
			default:
				...
				if(bid ==0) {
					...
					response.sendRedirect("SBookBlocks.jsp");
				}else {
					session.setAttribute("failurebooking", "You have already booked!");
		...
		case "book hostels":
			...
			if(hs != null) {
				...
				response.sendRedirect("SBookHostels.jsp");
			}else {
		...
		case "book rooms":
			...
			if(rm != null) {
				...
				response.sendRedirect("SBookRooms.jsp");
			}else {
		...
		case "book beds":
			...
			if(bd != null) {
				...
				response.sendRedirect("SBookBeds.jsp");
			}else {
